...
langs = {
  ...
  theme_caption : {
    ...
    de: 'Themen ändern Sie unter Layout &raquo; Themenauswahl...',
  ...
  layout_caption : {
    ...
    de: 'Benutzerdefinierte Layouts können Sie unter Layout &raquo; Layouts erstellen.',
  ...
  ribbon_head : {
    ...
    de: '3) Ribbon oder Menü/Symbolleisten',
  ...
  ribbon_caption : {
    ...
    de: 'Durch einen Klick mit der rechten Maustaste auf das Ribbon oder das Menü können Sie später zwischen den Anzeigen wechseln.',
  ...
  backup_option_1 : {
    ...
    de: '.bak-Dateien erstellen, wo die Originaldatei gespeichert ist',
