...
class Dytt8SpiderSpider(scrapy.Spider):
    ...
    def detail(self, response):
        ...
        if name[0]=="" or category[0]==""or country[0]==""or douban_rate[0]==""or language[0]==""or publish_date[0]==""or IMDb_rate[0]==""or movie_time[0]==""or director[0]=="" \
                or main_actor[0] == ""or introduce[0]==""or download_url[0]=="":
            pass
        else:
            if name:
                item['name'] = name[0]
